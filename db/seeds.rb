...
User.destroy_all
count = 1
xls_file = Roo::Excelx.new('/Users/dobbelsaurelien/code/adobbels/handident/db/data.xlsx')
s = Roo::CSV.new("/Users/dobbelsaurelien/code/adobbels/handident/db/test.csv")
xls_file.to_csv("/Users/dobbelsaurelien/code/adobbels/handident/db/test.csv")
CSV.foreach("/Users/dobbelsaurelien/code/adobbels/handident/db/test.csv") do |row|
    puts "seed n° #{count}"
  if row[9] == "Ville"
  else
    user = User.create!(
